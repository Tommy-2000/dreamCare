import '../common/navigation/custom_bottom_nav_bar.dart';
import '../common/navigation/custom_nav_rail.dart';
...
class _RootScaffoldState extends State<RootScaffold> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Row(
        children: [
          if (landscapeWindow) CustomNavRail(widget.navigationShell),
          Expanded(child: widget.navigationShell),
        ],
      ),
      bottomNavigationBar: landscapeWindow
          ? null
          : CustomBottomNavBar(widget.navigationShell),
    );
  }
}
